...
%----------------Modified by Duke-NUS to output peakvlf, peaklf,peakhf
...
%                                5 - Success
%               out.peakvlf/peaklf/peakhf: peak in Hz in VLF, LF and HF
%               --Duke-NUS
%               out.psd/f 
%            
%
...
%%%------Duke-NUS------%%%
out.peakvlf = nan(1,length(tWin));
out.peaklf = nan(1,length(tWin));
out.peakhf = nan(1,length(tWin));
            ...
            switch method
                ...
                case 'lomb'
                    try
                        ...
                        [out.ulf(iWin), out.vlf(iWin), out.lf(iWin), out.hf(iWin), out.lfhf(iWin),...
                            out.ttlpwr(iWin), out.peakvlf(iWin),out.peaklf(iWin), out.peakhf(iWin)] = CalcLfHfParams_Revised(PSDlomb, Flomb, limits, plot_on);
                        out.psd(iWin,:) = PSDlomb';
                        out.f(iWin,:) = Flomb';
                ...
                case 'welch'                    
                    ...
                    try
                        ...
                        %%Duke-NUS%%%
                        [out.ulf(iWin), out.vlf(iWin), out.lf(iWin), out.hf(iWin), out.lfhf(iWin),...
                                out.ttlpwr(iWin),out.peakvlf(iWin),out.peaklf(iWin), out.peakhf(iWin)] = CalcLfHfParams_Revised(PSDwelch, Fwelch, limits, plot_on) ; 
                        
                        out.psd(iWin,:) = PSDwelch';
                        out.f(iWin,:) = Fwelch';
                ...
                case 'fft'
                    ...
                    try
                        ...
                        %%Duke-NUS%%%
                        [out.ulf(iWin), out.vlf(iWin), out.lf(iWin), out.hf(iWin), out.lfhf(iWin),...
                                out.ttlpwr(iWin),out.peakvlf(iWin),out.peaklf(iWin), out.peakhf(iWin)] = CalcLfHfParams_Revised(PSDfft(1:length(Ffft)), Ffft, limits, plot_on);
                        out.psd(iWin,:) = PSDfft';
                        out.f(iWin,:) = Ffft';                        
                ...
                case 'burg'
                    ...
                    %%Duke-NUS%%%
                    [out.ulf(iWin), out.vlf(iWin), out.lf(iWin), out.hf(iWin), out.lfhf(iWin),...
                            out.ttlpwr(iWin),out.peakvlf(iWin),out.peaklf(iWin), out.peakhf(iWin)] = CalcLfHfParams_Revised(PSD_Burg1,f_Burg1, limits, plot_on);
                    out.psd(iWin,:) = PSD_Burg1';
                    out.f(iWin,:) = f_Burg1';                         
