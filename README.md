...
<p align = "center">
<img src="https://latex.codecogs.com/svg.image?\bg_white&space;Y_{i}&space;&space;=&space;\sum_{j&space;=&space;1}^{n}X_{(i-1)*m&plus;j}&space;(j&space;=&space;1,2,3,&space;...,&space;M)" title="\bg_white Y_{i} = \sum_{j = 1}^{n}X_{(i-1)*m+j} (j = 1,2,3, ..., M)" />
</p>
